...
- 构建工具选型矩阵：[`matrix__bundler-webpack-vite-rollup`](/docs/career/interview-prep/matrix__bundler-webpack-vite-rollup#对比表格)
- 技术卡：
  - [`tech__webpack`](/docs/career/interview-prep/tech__webpack#原理简述)
  - [`tech__vite`](/docs/career/interview-prep/tech__vite#原理简述)
  - [`tech__rollup`](/docs/career/interview-prep/tech__rollup#原理简述)
