...
本模块收录 **TypeScript** 相关笔记与实战记录，请从左侧目录选择具体章节。

## 关联面试卡（快速跳转）

- 技术卡：[`tech__typescript`](/docs/career/interview-prep/tech__typescript#原理简述)
- 工程化关联：[`project__dji-rms`](/docs/career/interview-prep/project__dji-rms#原理简述)
