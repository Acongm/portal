...
- 技术卡：[`tech__react`](/docs/career/interview-prep/tech__react#原理简述)
- 性能方法论：[`tech__performance`](/docs/career/interview-prep/tech__performance#原理简述)
...
React 16 开始替换掉了`Stack Reconciler`，开始使用启发式算法架构的的`Fiber Reconciler`。那么为什么要发生这个改变呢？
